...
public class ArrayListStringConvertor {
	...
	public static String convertFrom2DArrayToString(int [][] list){
		StringBuilder sb = new StringBuilder();
		for (int[] l : list) {
				sb.append(convertFrom1DArrayToString(l));
				sb.append('\n');
			}
		return sb.toString().trim();
	}
	
	public static String convertFrom1DArrayToString(int [] list){
		StringBuilder sb = new StringBuilder();
	...
	public static String convertFrom1DArrayToString(String [] list){
		StringBuilder sb = new StringBuilder();
		for (int i = 0; i < list.length; ++i) {
			sb.append(list[i]);
			sb.append('\n');
